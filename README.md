...
Resumo das Interações Químicas e Moleculares (Mecanismos Epigenéticos) no LES

O Lúpus Eritematoso Sistêmico (LES) é caracterizado por interações complexas entre genes de suscetibilidade e fatores ambientais.
As principais interações moleculares que afetam a regulação dos genes e proteínas no LES ocorrem por meio de três mecanismos epigenéticos interconectados:

1. Metilação do DNA por CpG-DNA

A metilação é uma modificação química que adiciona grupos metil (CH₃) ao DNA, levando ao silenciamento de genes.
No LES há hipometilação em genes como CD70 e PRF1, resultando em hiperexpressão e autoimunidade.

2. Modificações da Cauda de Histonas

As histonas sofrem acetilação e metilação, influenciando a transcrição gênica.
Alterações nas histonas H3 e H4 em regiões promotoras de IFN-γ e receptores T afetam diretamente a resposta imune.
...
ZHAO, M.; LIU, S.; WANG, Y.; et al. Epigenetic mechanisms in systemic lupus erythematosus and other autoimmune diseases. Clinical Immunology, v. 155, n. 1, p. 1–12, 2014.

HEDRICH, C. M.; TSOKOS, G. C. Epigenetic mechanisms in systemic lupus erythematosus and other autoimmune diseases. Trends in Molecular Medicine, v. 17, n. 12, p. 714–724, 2011.

REILLY, C. M.; et al. Epigenetic therapeutics in autoimmune and inflammatory diseases. Nature Reviews Rheumatology, v. 17, p. 591–607, 2021.

TANG, Y.; et al. MicroRNAs and lupus: From pathogenesis to novel therapeutic opportunities. Frontiers in Immunology, v. 12, 2021.
